...
def identity_block(input_tensor, kernel_size, filters, stage, block):
    ...
    x = Conv2D(nb_filter1, 1, name=conv_name_base + '2a')(input_tensor)
    ...
    x = Conv2D(nb_filter3, 1, name=conv_name_base + '2c')(x)
...
def conv_block(input_tensor, kernel_size, filters, stage, block, strides=(2, 2)):
    ...
    x = Conv2D(nb_filter1, 1, strides=strides, name=conv_name_base + '2a')(input_tensor)
    x = BatchNormalization(axis=bn_axis, name=bn_name_base + '2a')(x)
    x = Activation('relu')(x)
    ...
    shortcut = Conv2D(nb_filter3, 1, strides=strides, name=conv_name_base + '1')(input_tensor)
...
def resnet50_model(img_rows, img_cols, color_type=1, num_classes=None):
    ...
    sgd = SGD(lr=5e-3, decay=5e-7, momentum=0.9, nesterov=True)

...
urlpatterns = [
    ...
    url(r'^annotate-interior-exterior$', views.annotate_interior_exterior,
        name='annotate_interior_exterior'),
    url(r'^annotate-interior-exterior-stats$', views.annotate_interior_exterior_stats,
        name='annotate_interior_exterior_stats'),
]
